...
import type { ChartOHLCProps, CandlestickChartAPI, CandlestickSeriesApi } from '../types/charts'
import { useCandlestickChart } from '../hooks/useChartInitialization'

export const ChartOHLC = forwardRef<CandlestickChartAPI, ChartOHLCProps>(
  function ChartOHLC(_props, ref) {
