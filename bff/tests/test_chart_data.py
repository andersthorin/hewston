...
class TestChartDataEndpoint:
    ...
    def test_chart_data_daily_success(
    ...
    def test_chart_data_minute_decimated(
        self, test_client: TestClient, mock_backend_client, mock_backend_response
    ):
    ...
    def test_chart_data_backend_error(
        ...
        response = test_client.get(
            "/api/v1/chart-data",
            params={"symbol": "AAPL", "timeframe": "1D", "from": "2024-01-01", "to": "2024-01-31"},
        )
...
class TestDataTransformation:
    ...
    def test_transform_backend_bars(self):
        ...
        bars = transformer.transform_backend_bars(
            backend_data, TimeframeEnum.DAILY, "test-correlation-id"
        )
