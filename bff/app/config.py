...
BFF_API_DESCRIPTION = (
    "Backend-for-Frontend service providing aggregated APIs for Hewston trading platform"
)
...
HEALTH_CHECK_DEPENDENCIES = ["backend_api", "redis" if REDIS_ENABLED else None]
